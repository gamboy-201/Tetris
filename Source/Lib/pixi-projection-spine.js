/*!
 * pixi-projection - v0.3-Quest
 * Compiled Fri, 20 Dec 2019 15:58:00 IST
 *
 * Unofficially, compiled for Quest.
 * Requires PIXI-v5.1.x or up.
 *
...
(function (pixi_projection) {
    var Spine2d = (function (_super) {
        ...
        Spine2d.prototype.newMesh = function (texture, vertices, uvs, indices, drawMode) {
            return new pixi_projection.SimpleMesh2d(texture, vertices, uvs, indices, drawMode);
        };
...
(function (pixi_projection) {
    var Spine3d = (function (_super) {
        ...
        Spine3d.prototype.newMesh = function (texture, vertices, uvs, indices, drawMode) {
            return new pixi_projection.SimpleMesh3d2d(texture, vertices, uvs, indices, drawMode);
        };
